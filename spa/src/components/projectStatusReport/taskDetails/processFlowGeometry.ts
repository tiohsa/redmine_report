...
export const PROCESS_FLOW_YEAR_ROW_HEIGHT = 32;
export const PROCESS_FLOW_MONTH_ROW_HEIGHT = 32;
...
const PROCESS_FLOW_BAR_HEIGHT = 20;
const PROCESS_FLOW_BAR_SPACING_Y = 12;
const PROCESS_FLOW_POINT_DEPTH = 20;
